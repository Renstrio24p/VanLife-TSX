...
export default function Vans() {
  ...
  function handleFilterChange(key: TypeLiteral, value: TypeParamsVan) {
  ...
  function RenderVanElements(vans: VanTypes[]){
        const displayedVans = typeFilter
          ? vans?.filter((van: VanTypes) => van.type === typeFilter)
          : vans;

        const vanElements = displayedVans?.map((van: VanTypes) => (
